...
export default function Home() {
  ...
  const filtrados = allProducts.filter(pegaItem => pegaItem.title.includes('jacket') 
        || pegaItem.title.includes('coat') 
        || pegaItem.description.includes('jacket') || pegaItem.description.includes('coat'))
  ...
  return (
    <div>
      ...
      <SectionContainer title="Baratissimos">
        {allProducts
